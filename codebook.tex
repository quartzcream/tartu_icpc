...
struct HullDynamic : public multiset<Point> {@ $ \hfill #4448 $ @
  ...
  ll eval(int x) {    // upper maximize dot({x, 1}, v)
    ...
    return (ll)it->p.F * x + it->p.S;@ $ \hfill #4790 $ @
  }
};@ $ \hfill %3487 $ @
struct Hull {
  vector<Seg> hull;
