...
\usepackage[a4paper, hmarginratio=1:1,top=20mm, bottom=5mm, columnsep=0mm, left=10mm, right=10mm]{geometry}
\usepackage{harpoon}
...
\section*{3D geometry}
\noindent
$\orient(P, Q, R, S) = (\vv{PQ} \times \vv{PR}) \cdot \vv{PS}$. $S$ above $PQR$ iff $>0$. \\
